...
public final class Math2 {
     ...
     * @param x Le point d'abscice en lequel on calcul y
    ...
    /**
     * Limite la valeur v à l'intervalle allant de min à max.<br>
     * Si v est en dehors de cet intervale, on le ramène à la borne la plus proche.
     * @param min Valeur minimale de l'intervale
     * @param v Valeur à limiter
     * @param max Valeur maximale de l'intervale
     * @return v si v appartient à l'intervale, min si v < min, max si v > max
     */
